...
subtitle: Published in *The American Naturalist*
date: last-modified
author: 
  - Archambeau Juliette
  - Marta Benito-Garzón
...
```{r}
#| label: tbl-ClimCG
#| tbl-cap: Climate in the five common gardens between the planting date and the measurement date. See Table [-@tbl-SelectedClimaticVariableInformation] for the full names and units of the climatic variables.
