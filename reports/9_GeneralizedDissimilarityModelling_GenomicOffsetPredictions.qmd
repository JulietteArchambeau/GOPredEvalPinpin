...
if(x$set_code=="cand"){ 
  ...
  ggsave(here("figs/GDM/NFI_GOmap_CandidateSNPs_SI.pdf"), p_SI, width=6,height=6, device="pdf")
  ggsave(here("figs/GDM/NFI_GOmap_CandidateSNPs_SI.png"), p_SI, width=6,height=6)
  
  } else if(x$set_code=="control"){
    p_SI <- p + theme(plot.title = element_blank())
    ggsave(here("figs/GDM/NFI_GOmap_ControlSNPs_SI.pdf"), p_SI, width=6,height=6, device="pdf")
    ggsave(here("figs/GDM/NFI_GOmap_ControlSNPs_SI.png"), p_SI, width=6,height=6)
    }
