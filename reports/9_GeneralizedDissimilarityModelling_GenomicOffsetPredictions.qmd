...
```{r LoadGOrasters, eval=F}
list_pred_rasts <- readRDS(here("outputs/GDM/go_pred_rasters.rds"))
```


```{r PlotGorasters, fig.width=12,fig.height=6, message=F, results="hide", eval=F}
par(mfrow=c(1,2))
...
```{r PlotMeanGOProjections, fig.height=8, fig.width=8, warning=F, eval=F}
# Map options
# ===========
point_size = 2
x_limits = c(-10, 15)
