...
```{r PlotMeanGOProjections, fig.height=8, fig.width=8, warning=F, eval=T}
# Map options
# ===========
point_size = 2
x_limits = c(-10, 15)
...
p %>% ggsave(here("figs/GDM/GOmeanProjections_AllCandSNPs.pdf"),., width=8,height=8, device="pdf")
p %>% ggsave(here("figs/GDM/GOmeanProjections_AllCandSNPs.png"),., width=8,height=8)
p
```
