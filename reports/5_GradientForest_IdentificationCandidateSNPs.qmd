...
GF runs because the outputs vary from one run to another. Below is the comparison of the outliers selected with three different runs of GF not corrected for population structure.
