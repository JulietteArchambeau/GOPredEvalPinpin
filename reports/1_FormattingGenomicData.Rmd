...
We export in the DRYAD repository two datasets (filtered or not for MAF) containing information about the different IDs and the genome position of each SNP. SNPs are in rows. 
