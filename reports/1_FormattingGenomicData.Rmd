...
snp_match_1 <- read.csv("data/GenomicData/SnpCodesMatching.csv") %>% 
  set_colnames(paste0(colnames(.),"_SNP1")) %>% 
  rename(SNP1 = snp_ID_SNP1)

snp_match_2 <- read.csv("data/GenomicData/SnpCodesMatching.csv") %>% 
...
For the DRYAD repository, we save 
...
codes <- read.csv("data/GenomicData/SnpCodesMatching.csv")

temp_df <- read.csv("data/GenomicData/SnpCodesMatching.csv") %>% 
