...
df %>% 
  ...
  write_csv(paste0("data/DryadRepo/FormattedFilteredGenomicData_",ncol(df),"clones_",nrow(df),"snps.csv"),
            append=FALSE)

# downloading the formatted genomic data with SNP ID as first column: read.csv("data/DryadRepo/FormattedFilteredGenomicData_454clones_9817snps.csv",row.names = 1)
# or downloading the formatted genomic data with SNP ID as row names: read.csv("data/DryadRepo/FormattedFilteredGenomicData_454clones_9817snps.csv")
```
