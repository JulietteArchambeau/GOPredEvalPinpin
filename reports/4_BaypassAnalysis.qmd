...
We load the population-specific climatic information for the climatic variables of interest. We use the following climatic variables (set 2 in the report `2_RedundancyAnalysis_part1.Rmd`):
...
clim_past <- generate_clim_datasets(clim_var)[["clim_past"]]
