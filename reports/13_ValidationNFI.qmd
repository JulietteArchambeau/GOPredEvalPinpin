...
```{r ObservedAnnualProbMortalityMap, fig.width=7, fig.height=7}
p <- ggplot() + 
...
```{r MapsClimaticDIfferences, fig.width=7, fig.height=7}
...
```{r PlotCorrelationsModelM62WithPredictionsWithoutGO, fig.height=8, fig.width=10}
