...
We run a PCA on the allele frequencies of the **candidate SNPs**, and generate the scree plot and the PCA plot with the populations.

```{r PlotsCandidateSNPs}
# names of the candidate SNPs
cand <- readRDS(here("outputs/list_snp_sets.rds"))[["cand"]]$set_snps
...
We run a PCA on the allele frequencies of the **control SNPs**, and generate the scree plot and the PCA plot with the populations.

```{r PlotsControlSNPs}
# names of the control SNPs
control <- readRDS(here("outputs/list_snp_sets.rds"))[["control"]]$set_snps

# keep the genomic data of the control SNPs
geno_control  <- geno[,control]
