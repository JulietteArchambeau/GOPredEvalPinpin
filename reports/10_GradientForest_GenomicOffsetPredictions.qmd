...
This figure corresponds to Figure 6b in the main manuscript.
:::
...
if(x$set_code=="cand"){ 
  ...
  ggsave(here("figs/GF/NFI_GOmap_CandidateSNPs_SI.png"), p_SI, width=8,height=8)
  
  } else if(x$set_code=="control"){
    p_SI <- p + theme(plot.title = element_blank())
    ggsave(here("figs/GF/NFI_GOmap_ControlSNPs_SI.pdf"), p_SI, width=8,height=8, device="pdf")
    ggsave(here("figs/GF/NFI_GOmap_ControlSNPs_SI.png"), p_SI, width=8,height=8)
    }
