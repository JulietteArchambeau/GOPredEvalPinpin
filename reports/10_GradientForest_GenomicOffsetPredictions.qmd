...
```{r GenerateGFplots, results="hide", warning =F}
# ==============================
...
if(x$set_code=="cand"){ 
  ...
  ggsave(here("figs/GF/GOMaps_PopLocations_CandidateSNPs_SI.png"), go_maps, width=10,height=6)
    ...
    ggsave(here("figs/GF/GOMaps_PopLocations_ControlSNPs_SI.png"), go_maps, width=10,height=6)
    }
...
p %>% ggsave(here("figs/GF/GOmeanProjections_CandSNPs.png"),., width=8,height=8)
...
if(x$set_code=="cand"){ 
  ...
  ggsave(here("figs/GF/NFI_GOmap_CandidateSNPs_SI.pdf"), p_SI, width=6,height=6, device="pdf")
  ggsave(here("figs/GF/NFI_GOmap_CandidateSNPs_SI.png"), p_SI, width=6,height=6)
  
  } else if(x$set_code=="control"){
    p_SI <- p + theme(plot.title = element_blank())
    ggsave(here("figs/GF/NFI_GOmap_ControlSNPs_SI.pdf"), p_SI, width=6,height=6, device="pdf")
    ggsave(here("figs/GF/NFI_GOmap_ControlSNPs_SI.png"), p_SI, width=6,height=6)
    }
...
```{r MapNFIclimates, fig.height=10, fig.width=12}
world <- ne_countries(scale = "medium", returnclass = "sf")
...
p <- lapply(snp_sets, function(x){
 ...
 if(x$set_code=="cand") {
   ...
   p_SI %>% 
   ggsave(filename = here(paste0("figs/GF/GOmap_",x$set_code,"_",cg_name,"_SI.png")),width=5,height=5)
  ...
  if(x$set_code=="control") {
   ...
   p_SI %>% 
   ggsave(filename = here(paste0("figs/GF/GOmap_",x$set_code,"_",cg_name,"_SI.png")), width=7,height=5)
