...
Most analyses conducted in the present report were conducted following @fitzpatrick2021experimental and @capblancq2023common, and the R code arebased on [the github repository](https://github.com/fitzLab-AL/geneticOffsetR) associated with @fitzpatrick2021experimental. 
...
list_outliers <- list("RDA" = rda_outliers[[5]]$outliers$snp,
                      "RDA + PS" = rda_outliers[[6]]$outliers$snp,
                      "GF-raw" = gf_out$gf_raw$set3_var$outliers$outliers001,
                      "GF-X" = gf_out$gf_X$set3_var$outliers$outliers001)
...
ggVennDiagram(list_outliers,lty="solid", size=0.2) + 
  ...
  guides(fill = "none") + 
  #labs(caption='Set 3 climatic variables') +
