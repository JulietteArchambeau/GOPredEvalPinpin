...
png(here("figs/RDA/AdaptiveIndexMap_CandidateSNPs_SI.png"), width=9,height=4.9)
ai_maps[[1]] + theme(plot.title = element_blank())
dev.off()
...
png(here("figs/RDA/AdaptiveIndexMap_ControlSNPs_SI.png"), width=9,height=4.9)
ai_maps[[3]] + theme(plot.title = element_blank())
dev.off()
...
if(x=="cand"){ 
  ...
  ggsave(here("figs/RDA/GOMap_CandidateSNPs_SI.png"), go_maps, width=11,height=7)
} else if(x=="control"){
  ggsave(here("figs/RDA/GOMap_ControlSNPs_SI.pdf"), go_maps, width=11,height=7, device="pdf")
  ggsave(here("figs/RDA/GOMap_ControlSNPs_SI.png"), go_maps, width=11,height=7)
}
...
go_maps %>%  saveRDS(file=here("outputs/RDA/GOmaps.rds"))
```

```{r ShowGOmaps}
go_maps <- readRDS(file=here("outputs/RDA/GOmaps.rds"))
...
if(x$set_code=="cand"){ 
  ...
  ggsave(here("figs/RDA/NFI_GOmap_CandidateSNPs_SI.png"), p_SI, width=8,height=8)
  
  } else if(x$set_code=="control"){
    p_SI <- p + theme(plot.title = element_blank())
    ggsave(here("figs/RDA/NFI_GOmap_ControlSNPs_SI.pdf"), p_SI, width=8,height=8, device="pdf")
    ggsave(here("figs/RDA/NFI_GOmap_ControlSNPs_SI.png"), p_SI, width=8,height=8)
    }
