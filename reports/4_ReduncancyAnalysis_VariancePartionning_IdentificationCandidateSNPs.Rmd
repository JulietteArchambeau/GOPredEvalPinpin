...
`r length(snps_identifiedwithoutMAF_notwithMAF)` SNPs were identified in the RDA corrected *without* MAF but not in the RDA corrected *with* MAF.
...
`r length(snps_identifiedwithMAF_notwithoutMAF)` SNPs were identified in the RDA corrected *with* MAF but not in the RDA corrected *without* MAF. 
