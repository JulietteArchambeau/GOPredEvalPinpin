...
Thus, for the second objective of this paper (which is to provide genomic offset estimates for the studied populations), whether or not to include winter conditions in genomic offset predictions is a tricky question, for which there is probably no correct answer. 

In the present study, we decided not to include climatic variables related to cold-winter temperatures.
