...
subtitle: "Selection of the climatic variables, variance partitionning & candidate SNPs identification"
...
clim %>% 
  ...
  colnames() %>% 
  saveRDS(file="outputs/VariableSelection/PreselectedClimaticVariableNames.rds")
```
...
p %>% ggsave(file="figs/ExploratoryAnalyses/DistributionPreselectedClimaticVariables.png",
               width=15,height=12)
...
# ===
fig_options <- list(
  path = "figs/ExploratoryAnalyses/CorrplotClimVariables.pdf",
  width=10,
  height=8)
...
pdf(width=9,height=5,"figs/RDA/PCAplot.pdf")
...
tab <- readRDS(file="outputs/RDA/SummaryVartPartPopLevel_dbMEMs.rds")[[2]]
...
pdf(file="figs/RDA/treemap_VarPart.pdf")
treemap(tab,
        index="names",
        vSize="vals",
        title = "",
...
ggsave(plot_row, device = "pdf", filename = paste0("figs/RDA/SI_outlier_plots_",rda_name,".pdf"), width=12, height=5)
}
...
p %>% ggsave(device="pdf",
             file="figs/ExploratoryAnalyses/DistributionSelectedClimaticVariables.pdf",
             width=10,height=8)
