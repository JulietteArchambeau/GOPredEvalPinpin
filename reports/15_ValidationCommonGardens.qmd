...
```{r HeightInterceptsInDryadRepo, echo=F}
# we export this dataset for the DRYAD repository
...
```{r CoefftabMortalityModels, eval=F}
coefftab <- lapply(unique(survival_data$site),function(site_i){
...
```{r CoeffPlotsMortalityModels, fig.height=9, fig.width=12, eval=T, warning=F}
...
```{r MortalityPredictions, message=F,warning=F, fig.height=6, fig.width=6, eval=F, results='hide'}
####################################################################################################
...
```{r extractMortalityProbabilityModelWithoutGO, eval=F}
...
```{r PlotCorrelationsModelWithoutGO, eval=T, warning=F, results='hide'}
...
p_corr  <- lapply(correlation_types, function(coeff){
...
return(p_allvar_images)

})
```

```{r ShowCorrPlotMortalityModels,fig.height=9, fig.width=12}
lapply(p_corr, function(x) x)
```
...
```{r ModelCoeffM1, fig.width=15, fig.height=13.6, eval=T, message=F, warning=F}
...
```{r MakePolyPlotsM1, fig.width=12, fig.height=7, eval=F}
...
```{r IntervalPlotsM2, fig.width=15, fig.height=13.6, eval=T, message=F, warning=F}
...
```{r PolyPlotsM2, fig.width=12, fig.height=7, eval=F}
...
```{r HeightPredictionsM2, message=F,warning=F, fig.height=6, fig.width=6, eval=F, results='hide'}
#############################################################################
...
```{r BuildCorrTabHeightModelWithoutPredictorWithPredictions, message=F, warning=F, eval=F}
...
```{r ShowCorrPlotHeightModels,fig.height=9, fig.width=12}
lapply(p_corr, function(x) x)
```
...
```{r IntervalPlotsM3, fig.width=15, fig.height=13.6, eval=T, message=F, warning=F}
...
```{r PolyPlotsM3, fig.width=12, fig.height=7, eval=F}
...
```{r IntervalPlotsM4, fig.width=15, fig.height=13.6, eval=T, message=F, warning=F}
...
```{r PolyPlotsM4, fig.width=12, fig.height=7, eval=F}
