...
list_snps$LFMM <- readRDS(file=here("outputs/LFMM/go_predictions_snpsets.rds"))[[x$set_code]][["go_cg"]]
...
return(clim_dist)
  ...
  mutate(method = "CTD",
         ...
         input_name = case_when(input_code == "bio1" ~ "Mean annual temperature (bio1, °C)",
                                ...
                                input_code == "EucliDist" ~ "Euclidean climatic distance"),
         method_input_code = paste0("CTD_", input_code),
...
```{r extractMortalityProbabilityModelWithoutGO}
...
```{r PlotCorrelationsModelWithoutGO}
