...
return(clim_dist)
  ...
  mutate(method = "CTD",
         ...
         input_name = case_when(input_code == "bio1" ~ "Mean annual temperature (bio1, °C)",
                                ...
                                input_code == "EucliDist" ~ "Euclidean"),
         method_input_code = paste0("CTD_", input_code),
...
```{r ModelCoeffM1, fig.width=14, fig.height=11, eval=T}
...
```{r IntervalPlotsM2, fig.width=14, fig.height=11, eval=T}
...
```{r IntervalPlotsM3, fig.width=14, fig.height=11, eval=T}
...
```{r IntervalPlotsM4, fig.width=14, fig.height=11, eval=T}
