...
We export the height intercepts from @archambeau2022combining to the DRYAD repository: `HeightIntercepts_Archambeauetal2022.csv`
:::
...
We export mortality and height data in the DRYAD repository: `CommonGardenData_cleaned.csv` dataset.
:::
