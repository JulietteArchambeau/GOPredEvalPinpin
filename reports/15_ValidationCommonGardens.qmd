...
#### Posterior draws and uncertainty intervals

The graphs above do not show the estimate uncertainty. We generate some graphs to visualise the uncertainty around the estimates :
...
methods <- list(LFMM_all = "LFMM and all SNPs",
...
ggsave(p,
       file=here(paste0("figs/ValidationCommonGarden/HeightModels/HeightPredictions_",group_name,"_",site_i,"_M2.png")),
       device="png",
       height=12,
       width=fig_width,
       dpi=600)
